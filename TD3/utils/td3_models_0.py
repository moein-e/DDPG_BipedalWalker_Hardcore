...
class Actor(nn.Module):
    def __init__(self, state_dim, num_actions, seed, units_fc1=32):
...
class Critic(nn.Module):
    def __init__(self, state_dim, num_actions, seed, units_fc1=64, units_fc2=64, units_fc3=0):
        ...
        self.linear4 = nn.Linear(units_fc2, 1)
